...
class Card extends React.Component {
  ...
  getArrowStyle() {
    ...
    let { position: _position, arrow } = this.props;
    const position = this.finalPosition || _position;
  ...
  getStyle(_position, arrow) {
    ...
    const changePosition = left > halfScreen && _position === 'right';
    const position = changePosition ? 'left' : _position;
