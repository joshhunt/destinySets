...
const RENEWED_HUNTER = 3270435524;
const RENEWED_TITAN = 689787432;
const RENEWED_WARLOCK = 2223917115;

const MAJESTIC_HUNTER = 3270435527;
const MAJESTIC_TITAN = 689787435;
const MAJESTIC_WARLOCK = 2223917112;

const MAGNIFICENT_HUNTER = 3270435526;
const MAGNIFICENT_TITAN = 689787434;
const MAGNIFICENT_WARLOCK = 2223917113;
...
const FINISHED_IF_MAP = {
  [RENEWED_HUNTER]: 3280087347,
  [RENEWED_TITAN]: 1292425061,
  [RENEWED_WARLOCK]: 754050190,
  [MAJESTIC_HUNTER]: 343482208,
  [MAJESTIC_TITAN]: 2809967986,
  [MAJESTIC_WARLOCK]: 139281387
};
      ...
      <div className={s.gearMain}>
        ...
        {showDescription && (
          <p className={s.gearDescription}>
            <span>{gear.item.flavorText}</span>
          </p>
        )}
