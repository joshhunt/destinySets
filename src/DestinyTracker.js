  ...
  var Tooltip = (function() {
    function Tooltip() {
      ...
      if (document.addEventListener) {
        ...
        document.attachEvent('onmouseenter', function(e) {
          return _this.onDocumentMouseOver(e);
        });
    ...
    Tooltip.prototype.onDocumentMouseOver = function(e) {
      ...
      if (e.target.tagName == 'A') this.onLinkMouseOver(e);
    };
    ...
    Tooltip.prototype.detectUrl = function(url, target, callback) {
      if (url == null) return;
      if (target.getAttribute('data-dtr-tooltip') == 'no-show') return;
      if (
        url.indexOf('bungie.net') !== -1 ||
        url.indexOf('destinytracker.com') !== -1 ||
        url.indexOf('/') == 0
      ) {
    ...
    Tooltip.prototype.fetchTooltip = function(url, callback) {
      var _this = this;
      if (this.tooltipData[url] == '') return;
      if (this.tooltipData[url] !== undefined) {
        callback(this.tooltipData[url]);
        return;
      }
      this.tooltipData[url] = '';
      var request = new XMLHttpRequest();
      request.open('POST', 'https://db.destinytracker.com/api/tooltip');
      request.onload = function() {
        if (request.readyState == 4 && request.status == 200) {
          _this.tooltipData[url] = request.responseText;
